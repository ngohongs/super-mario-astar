...
javac -cp src src/mff/agents/benchmark/MyAgentBenchmarkMetacentrum.java
java -cp src mff.agents.benchmark.MyAgentBenchmarkMetacentrum $timeToFinishWeight $searchSteps

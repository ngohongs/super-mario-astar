...
javac -cp src src/mff/agents/benchmark/MyElectiveAgentBenchmarkMetacentrum.java
java -cp src mff.agents.benchmark.MyElectiveAgentBenchmarkMetacentrum $windowSize $searchSteps
